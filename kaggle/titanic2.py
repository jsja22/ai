...
test_df[TARGET] = pd.read_csv("C:/data/kaggle/pseudo_label.csv")[TARGET]
...
submission['submit_3'] = pd.read_csv("C:/data/kaggle/pseudo_label.csv")[TARGET]

submission[[col for col in submission.columns if col.startswith('submit_')]].sum(axis = 1).value_counts()

submission[['PassengerId', TARGET]].to_csv("C:/data/kaggle/csv/sub4.csv", index = False)
