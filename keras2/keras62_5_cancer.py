...
# <tensorflow.python.keras.wrappers.scikit_learn.KerasClassifier object at 0x000002CF06834AC0>
# {'optimizer': 'SGD', 'nodes': 64, 'lr': 0.001, 'drop': 0.2, 'batch_size': 16, 'activation': 'selu'}
# 0.9560532172520956
# 8/8 [==============================] - 0s 1ms/step - loss: 0.0690 - acc: 0.9825
# 최종 스코어 : 0.9824561476707458