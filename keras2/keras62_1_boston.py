...
# <tensorflow.python.keras.wrappers.scikit_learn.KerasRegressor object at 0x00000202001F7EE0>
# {'optimizer': 'rmsprop', 'nodes': 32, 'lr': 0.1, 'drop': 0.2, 'batch_size': 16, 'activation': 'tanh'}
...
# {'optimizer': 'rmsprop', 'nodes': 64, 'lr': 0.1, 'drop': 0.2, 'batch_size': 32, 'activation': 'selu'}
# -25.38872718811035
# 4/4 [==============================] - 0s 1ms/step - loss: 13.9571 - mae: 2.4142
# 최종 스코어 : -13.957139015197754
# 4/4 [==============================] - 0s 880us/step
# R2 : 0.8330144868906058