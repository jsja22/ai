...
# <tensorflow.python.keras.wrappers.scikit_learn.KerasClassifier object at 0x00000245062E69D0>
# {'optimizer': 'adam', 'nodes': 32, 'lr': 0.001, 'drop': 0.5, 'batch_size': 16, 'activation': 'sigmoid'}
# 0.9666666587193807
# 2/2 [==============================] - 0s 2ms/step - loss: 0.1269 - acc: 0.9667
