...
for train_index, valid_index in skf.split(train2,train['digit']) :
    ...
    mc = ModelCheckpoint('C:/data/computer vision/Dacon_computer_vision_0202_1.h5',save_best_only=True, verbose=1)
...
sub.to_csv('C:/data/computer vision/csv/Dacon_computer_vision_0202_1.csv',index=False)