...
model.fit([x1_train,x2_train], y_train, batch_size=32, epochs=1500, validation_data=([x1_val,x2_val],y_val),verbose=1, callbacks=[es, cp,reduce_lr])
...
#ReduceLROnPlateau -> patience =20으로 적용하였을때 
#loss, mae :  964940.625 709.7579956054688
#RMSE :  982.3139626375444
#R2 :  0.9843893511099404
#성능 올라감 !