...
from sklearn.preprocessing import MinMaxScaler,StandardScaler,RobustScaler  #이상치 제거를 하지 않은 상태에 RobustSCALER 사용하면 standardscaler보다 효과적이다 
scaler = RobustScaler()
scaler.fit(x)
...
print("R2 :",r2)
# loss: 12.806827545166016
# mae: 2.644113779067993
# RMSE :  3.5786628545458323
# R2 : 0.8467770069426079