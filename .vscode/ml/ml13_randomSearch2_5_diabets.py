...
from sklearn.datasets import load_iris ,load_breast_cancer ,load_wine ,load_diabetes#다중 분류모델
...
#최적의 매개변수: RandomForestRegressor(max_depth=10, min_samples_leaf=7, min_samples_split=10,
#                      n_jobs=2)
#최종정답률: 0.4066745798233051
#소요시간 : 11 seconds