...
def get_images(test_files):
    ...
    for path in test_files:
        ...
        image2 = cv2.resize(image2, (RE_SIZE, RE_SIZE))
...
if __name__ == "__main__":
    ...
    BASE_PATH = 'C:/data/computer_vision2/dirty_mnist_2'
    MODEL_PATH = 'C:/data/computer_vision2/models/2021_02_28_02_41'
    ...
    result_df.to_csv(f'{BASE_PATH}/result_{LOG_TIME}.csv', index=False)
