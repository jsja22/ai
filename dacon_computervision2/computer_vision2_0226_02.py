...
from models import getMultiLabelResNet50V2_01, getMultiLabelResNet50V2_02, getMultiLabelResNet50V2_03
    ...
    try:
        ...
        for model_index, model_function in enumerate(model_list):
            ...
            for fold_index, (train_index, val_index) in enumerate(kfold.split(train_x, train_y)):
                ...
                save_model_path = 'C:/data/computer_vision2/model/' + model_name + '/' + str(fold_index + 1)
            ...
            # csv file path
            csv_file_path = 'C:/data/computer_vision2/csv/' + model_name + '.csv'
