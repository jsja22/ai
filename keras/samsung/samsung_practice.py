...
# 1. 데이터
data_samsung_load = np.load('C:/data/npy/samsung.npy', allow_pickle= True)



#print(type(data_samsung_load)) #<class 'numpy.ndarray'>
#print(data_samsung_load.shape) #(2400, 14)
