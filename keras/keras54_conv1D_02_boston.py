...
from tensorflow.keras.layers import Dense, Input ,LSTM, Dropout, Conv1D, MaxPooling1D, Flatten, Dropout
...
model.fit(x_train, y_train, epochs=200, batch_size=32, validation_data =(x_val,y_val),callbacks=[early_stopping,cp])
...
#conv1D
#loss: 52.61481857299805
#mae: 4.748432159423828
