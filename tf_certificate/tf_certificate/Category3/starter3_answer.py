...
def solution_model():
    ...
    urllib.request.urlretrieve(url, 'C:/data/image/rps.zip')
    local_zip = 'C:/data/image/rps.zip'
    zip_ref = zipfile.ZipFile(local_zip, 'r')
    zip_ref.extractall('C:/data/image/tmp/')
    zip_ref.close()
...
if __name__ == '__main__':
    ...
    model.save("C:/data/tf_certificate/category3/mymodel.h5")
#[0.11062844842672348, 0.9603174328804016]